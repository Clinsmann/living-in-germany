    ...
    return <section className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
            <button
                ...
                disabled={isPending}
                className="h-12 border-1 border-gray-300 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800/20 active:bg-gray-100 dark:active:bg-gray-800/30 disabled:opacity-50 text-gray-700 dark:text-white rounded-xl transition-all duration-200 flex items-center justify-center focus:outline-none focus:ring-1 focus:ring-gray-500 focus:ring-offset-1 dark:focus:ring-offset-gray-900 cursor-pointer"
            >
