export const AdSpace = () => {
    return <aside className="bg-gray-50 dark:bg-gray-800/20 rounded-xl shadow-sm mb-6 p-4 text-center border border-gray-200 dark:border-gray-700/30 transition-colors duration-200">
