...
export function Sidebar({ open, onOpenChange, onFeedbackOpen, onScreenChange }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 z-50 shadow-2xl border-t border-gray-200 dark:border-gray-700 transform transition-all duration-300 ease-out rounded-t-2xl max-h-[85vh] ${
      ...
      >
        ...
        <div className="px-6 pb-6 max-h-[calc(85vh-60px)] overflow-y-auto">
          ...
          <header
            className={`flex items-center justify-between mb-6 transform transition-all duration-300 ease-out ${
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <label
                ...
                className="text-sm font-medium mb-3 block text-gray-700 dark:text-gray-300"
              >
                German State
              </label>
              <select
            ...
            >
              ...
              <div className="flex items-center justify-between p-3 border border-gray-200 dark:border-gray-600 rounded-lg">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-all duration-200 ease-out hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 ${
                ...
                >
                  <span
                    className={`inline-block size-4 transform rounded-full bg-white transition-transform duration-200 ease-out ${
