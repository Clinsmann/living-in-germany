...
import { Home, Bookmark, BookmarkCheck, Flag, Languages, Check, X, ChevronRight, ChevronLeft } from "lucide-react"
...
export function QuestionScreen({ mode, onMenuClick, onStatsUpdate, stats }: QuestionScreenProps) {
    ...
    const [bookmarkedQuestions, setBookmarkedQuestions] = useLocalStorage<number[]>("bookmarked-questions", [])
    const [answeredQuestions, setAnsweredQuestions] = useLocalStorage<Record<number, boolean>>("question-progress", {})
                                    ...
                                    <div className="flex items-center justify-between w-full">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="min-w-0">
                                                ...
                                                {showEnglish && (
                                                    <div className="text-sm opacity-70 mt-1 break-words">{currentQuestion.optionsEn[index]}</div>
                                                )}
                                            </div>
                                        </div>
                                        {showResult && (
